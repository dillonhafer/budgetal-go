          ...
          <div className="body-row">
            <div id="ppBody">
              ...
              <div className="innerText">
                ...
                <br />
                <div className="innerText">
                  Only to send half of an encryption key to mitigate forgery and
                  only when you sign in. We only set that one cookie. No Cookies
                  are used for any kind of tracking.
                </div>
                <br />
                <span id="trDi" />
                <br />
                ...
                <div className="blueText">
                  <span id="g-adsense" />
                  <strong data-magellan-destination="g-adsense">Google</strong>
                </div>
                <br />
                <div className="innerText">
                ...
                <div className="innerText">
                  ...
                  Commission, the nation’s consumer protection agency, enforces
                  the COPPA Rule, which spells out what operators of websites
